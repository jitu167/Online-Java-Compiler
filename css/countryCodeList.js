...
{"en":"Bosnia and Herzegovina", "cn":"波斯尼亚-黑塞哥维那", "code":"+387"},
...
{"en":"Croatia", "cn":"克罗地亚", "code":"+385"},
{"en":"Cuba", "cn":"古巴", "code":"+53"},
{"en":"Curacao", "cn":"库拉索", "code":"+599"},
...
{"en":"El Salvador", "cn":"萨尔瓦多", "code":"+593"},
{"en":"Equatorial Guinea", "cn":"赤道几内亚", "code":"+240"},
...
{"en":"Kampuchea (Cambodia )", "cn":"柬埔寨", "code":"+855"},
...
{"en":"Mauritania", "cn":"毛里塔尼亚", "code":"+222"},
...
{"en":"Papua New Guinea", "cn":"巴布亚新几内亚", "code":"+675"},
...
{"en":"Serbia", "cn":"塞尔维亚", "code":"+381"},
{"en":"Serbia and Montenegro", "cn":"塞黑", "code":"+381"},
...
{"en":"Tajikistan", "cn":"塔吉克斯坦", "code":"+992"},
...
{"en":"United Kingdom", "cn":"英国", "code":"+44"},
...
function buildOption(countryCode,language) {
	...
	return new Option(codeAndCountry,codeAndCountry);;
}
...
function buildOptions(element,language) {
	...
	if(language == "zh") {
		element.options[element.options.length] = new Option("其他","其他");
	} else {
		element.options[element.options.length] = new Option("Other","Other");
	}
}

function indexCountryCode(code) {
	var i = 0;
...
function countryCodeOfCountry(country,language) {
	...
	if(language == "zh") {
		for(var i = 0;i < countryCodeList.length;++i) {
			if(countryCodeList[i].cn == countryName) {
				return countryCodeList[i].code;
			}
		}
	} else {
		for(var i = 0;i < countryCodeList.length;++i) {
			if(countryCodeList[i].en == countryName) {
				return countryCodeList[i].code;
			}
		}
	}
