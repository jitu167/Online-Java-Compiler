...
public class Output extends Fragment {
	TextView output;
     ...
     {
   	  View rootview=infalte.inflate(R.layout.output, view,false);
   	  output=(TextView)rootview.findViewById(R.id.editorText);
	 ...
	 class result extends AsyncTask<String,String,String>
     {
 		...
 		protected String doInBackground(String ... params) {
 			...
 			try
			 {
				 ...
				 HttpPost post=new HttpPost(Config.url+"/androidcompile.jsp");
				...
				arr.add(new BasicNameValuePair("name",username));
			     ...
			     JSONObject res=new JSONObject(result.substring(result.indexOf("{"), result.lastIndexOf("}")+1));
 				     ...
 				     jsonstring=res.getString("output");
